...
static void Batt_Measure() {
	...
	ADDLOG_INFO(LOG_FEATURE_DRV, "DRV_BATTERY : %i : Measure Battery", xTaskGetTickCount());
#endif
...
void Batt_Init() {
#if ENABLE_TIMING_INFO_IN_LOG
	ADDLOG_INFO(LOG_FEATURE_DRV, "DRV_BATTERY : %i : Driver initialization", xTaskGetTickCount());
#endif
