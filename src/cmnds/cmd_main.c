...
#if defined(ENABLE_OBK_SCRIPTING) && (defined(WINDOWS) || defined(PLATFORM_BL602) || defined(PLATFORM_BEKEN) \
 || defined(PLATFORM_LN882H) || defined(PLATFORM_ESPIDF) || defined(PLATFORM_TR6260) || defined(PLATFORM_REALTEK))
