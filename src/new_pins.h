...
#define OBK_FLAG_POWER_INVERT_AC					46
#define OBK_FLAG_HTTP_NO_ONOFF_WORDS				47
#define OBK_FLAG_MQTT_NEVERAPPENDGET				48
#define OBK_FLAG_WIFI_ENHANCED_FAST_CONNECT			49
